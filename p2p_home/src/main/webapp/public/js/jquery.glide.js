    ...
    Glide.prototype.navigation = function () {
        ...
        if (_.slides.length > 1) {
            ...
            if (o.navCenter) {
                ...
                nav.css({
                    'left': '50%',
                    'width': (navChildren.outerWidth(true) == 0 ? 22 : navChildren.outerWidth(true)) * navChildren.length,
                    'margin-left': -(navChildren.outerWidth(true) == 0 ? (22 * navChildren.length) : nav.outerWidth(true)) / 2
                });
