var option = {
    'url': {
        'api_user': '/itcast_p2p_action/user/', //用户相关
        ...
        'api_verification': '/itcast_p2p_action/verification/',
    ...
    .factory('PostService', function ($http) {
        return {
            ...
            checkUserName: function ($str) {
                ...
                //相当于$http.post('/itcast_p2p_action/user/validateUserName', $str, option.header);
            },
            //验证手机是否可用
            ...
            getAbleAccout: function () {
                ...
                // /itcast_p2p_extracts/extractMoney
            },
            ...
            withdraw: function ($str) {
                ...
                // /itcast_p2p_action/charges/addMayTake
            },
